...
function repository() {
    return new Promise((resolve) => {
        ...
        mocha_1.describe('Repository', function () {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                mocha_1.it('deleting an not existing item from repository should return true', function () {
                    return __awaiter(this, void 0, void 0, function* () {
                ...
                mocha_1.it('adding a new document should return a persisted model', function () {
                    return __awaiter(this, void 0, void 0, function* () {
                        let model;
                        let model2;
                        let model3;
                ...
                mocha_1.it('repository without query should be exported as json', function () {
                    return __awaiter(this, void 0, void 0, function* () {
                        const json = yield repo.toJson().then((json) => {
                            return json;
                        }).catch((e) => {
                            return {};
                        });
                ...
                mocha_1.it('repository with matching query should be exported as json', function () {
                    return __awaiter(this, void 0, void 0, function* () {
                ...
                mocha_1.it('repository should be queried with all available operators', function () {
                    return __awaiter(this, void 0, void 0, function* () {
                ...
                mocha_1.it('model should not be accepted if it is from wrong instance type', function () {
                    return __awaiter(this, void 0, void 0, function* () {
                ...
                mocha_1.it('deleting an item from repository should return true', function () {
                    return __awaiter(this, void 0, void 0, function* () {
                ...
                mocha_1.it('not existing document should return null', function () {
                    return __awaiter(this, void 0, void 0, function* () {
